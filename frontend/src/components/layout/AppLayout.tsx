      ...
      <footer className="border-t py-8 md:py-10" role="contentinfo">
        <div className="container flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:justify-between">
            ...
            {/* Social links */}
            <nav className="flex items-center gap-4" aria-label="ArenaX social media">
              <a href="https://twitter.com/arenaxgg" target="_blank" rel="noopener noreferrer" aria-label="Follow ArenaX on Twitter / X" className="text-muted-foreground hover:text-foreground transition-colors">
              ...
              <a href="https://discord.gg/arenax" target="_blank" rel="noopener noreferrer" aria-label="Join the ArenaX Discord" className="text-muted-foreground hover:text-foreground transition-colors">
              ...
              <a href="https://instagram.com/arenaxgg" target="_blank" rel="noopener noreferrer" aria-label="Follow ArenaX on Instagram" className="text-muted-foreground hover:text-foreground transition-colors">
